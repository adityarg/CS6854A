...
def main():
    ...
    # print(years_q)
    # print(stats_q)
    kanpeki=[{'name': '2019'},{'name': '2018'},{'name': '2017'},{'name': '2016'},{'name': '2015'},{'name': '2014'},\
    {'name': '2013'},{'name': '2012'},{'name': '2011'},{'name': '2010'},{'name': '2009'},{'name': '2008'}]
    # print(kanpeki)
    years, stats = user_input(years_q, stats_q,kanpeki)
...
def get_year_stats():
    url = 'https://www.iplt20.com/stats/2020'
    years = []
    stats_url = []
    stats_title = []
    try:
